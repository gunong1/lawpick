        ...
        <footer className="bg-slate-900 text-slate-400 py-10 px-6 text-xs leading-relaxed">
            <div className="max-w-md mx-auto space-y-6">
                ...
                <div className="space-y-1">
                    <h5 className="text-slate-100 font-bold text-sm mb-2">코픽 (Kopick) | 서비스명: 로픽 (LawPick)</h5>
                    <p>대표자: 송치호 | 사업자등록번호: 687-09-02870</p>
                    <p>개업일: 2025년</p>
                    <p>주소: 대전광역시 서구 도산로 79, 1106동 705호</p>
                    <p>고객센터: <a href="mailto:support@lawpick.com" className="underline hover:text-slate-200">support@lawpick.com</a></p>
                </div>
